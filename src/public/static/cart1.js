...
//             // Check if the data has the necessary structure
//             if (data.response && data.response.items) {
//                 console.log(data.response);
//                 renderCart(data.response);  // Pass the full response, not just the items
//             } else {
...
// // Update renderCart function to handle data correctly
